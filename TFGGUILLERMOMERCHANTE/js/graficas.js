...
async function datosAula(val){
    try {
		...
		//comprueba la pantalla para ajustar el tamaño
        ...
        contenedor.style.cssText = `
            ...
            margin-left:${esMobile ? '0' : '10px'} !important;
        `;
        ...
        tabla.style.cssText = `
    		width: ${esMobile ? '100%' : '1200px'} !important;
    		height: ${esMobile ? 'auto' : '500px'} !important;
    		margin-right: 0px !important;
		`;
